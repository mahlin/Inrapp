...
namespace InrapporteringsPortal.Web
{
    public class EmailService : IIdentityMessageService
    {
        ...
        private void SendMail(IdentityMessage message)
        {
            ...
            string html = "Vänligen bekräfta ditt konto i Socialstyrelsens inrapporteringsportal genom att klicka på den här länken: <a href=" + message.Body + ">Bekräfta e-postsdress</a><br/>";
            #endregion
